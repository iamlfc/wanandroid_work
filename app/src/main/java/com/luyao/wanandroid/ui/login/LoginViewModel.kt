package com.luyao.wanandroid.ui.login
 ...
 * on 2019/4/2 16:36
 */
class LoginViewModel(val repository: LoginRepository, val provider: com.luyao.wanandroid.CoroutinesDispatcherProvider) : BaseViewModel() {
