package com.luyao.wanandroid.ui.main
...
import com.luyao.wanandroid.isLogin
...
class MainFragment : BaseFragment() {
    ...
    override fun initView() {
        ...
        addFab.setOnClickListener {
            if (!com.luyao.wanandroid.isLogin) Navigation.findNavController(viewPager).navigate(R.id.action_tab_to_login)
